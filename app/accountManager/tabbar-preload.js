...
function createTabElement(tab) {
	...
	iconEl.innerHTML = `<svg class="close-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/></svg>`;
	tabEl.appendChild(iconEl);

	// Tab name
	const nameEl = document.createElement('div');
	nameEl.className = 'tab-name';
	nameEl.textContent = tab.displayName || `Account ${tab.id?.substring(0, 8) || ''}`;
	...
	closeEl.innerHTML = '<svg class="close-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>';
